...
# %% auto 0
__all__ = ['bases', 'mut_rate', 'find_power_law_breakpoint_KS', 'estimate_U_n_hybrid', 'estimate_library_size']
...
def find_power_law_breakpoint_KS(
    ...
    alpha_threshold: float = 0.5, # New parameter for minimum alpha
    verbose: bool = False
) -> tuple:
    """
    ...
    for j_min_idx in range(N_obs - min_tail_size + 1):
...
def estimate_library_size(
    ...
    best_j_min, best_alpha, min_D = find_power_law_breakpoint_KS(pj_hat, min_tail_size=20, alpha_threshold=0.5, verbose=verbose)
