...
# %% auto 0
__all__ = ['data_path', 'lstm_path', 'model_TR_to_VR', 'firstmodel', 'secondmodel', 'one_hot_encode', 'one_hot_decode',
           'separate_model', 'generate_sequence_from_onehot', 'sequences_same_length', 'generate_sequences',
           'generate_sequences_oneTR', 'to_tensor_inputs', 'compute_likelihood', 'compute_likelihood_batch',
           'compute_likelihood_matrix']

# %% ../nbs/API/09_likelihood_LSTM.ipynb 2
...
# %% ../nbs/API/09_likelihood_LSTM.ipynb 5
lstm_path=os.path.join(data_path,'LSTM_model.keras')
model_TR_to_VR = tf.keras.models.load_model(lstm_path) #the LSTM model
