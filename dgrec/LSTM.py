...
# %% auto 0
__all__ = ['data_path', 'params_path', 'lstm_path', 'model_TR_to_VR', 'firstmodel', 'secondmodel', 'one_hot_encode',
           'one_hot_decode', 'separate_model', 'generate_sequence_from_onehot', 'sequences_same_length',
...
params_path=get_model_parameters_dir() #'../../dgrec/example_data'
...
lstm_path=os.path.join(params_path,'LSTM_model.keras')
