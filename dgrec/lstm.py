"""Deep learning models to predict the population of VR (Variable Region) sequences generated by a given TR design. Uses LSTM neural networks trained on DGRec experimental data. Includes functions for sequence generation, protein diversity evaluation, and likelihood computation."""

# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/API/09_lstm.ipynb.

# %% auto #0
__all__ = ['EPS', 'data_path', 'model_name', 'model_path', 'model_TR_to_VR', 'firstmodel', 'secondmodel',
           'masked_categorical_crossentropy', 'masked_accuracy', 'one_hot_encode', 'one_hot_decode', 'separate_model',
           'generate_sequence_from_onehot', 'sequences_same_length', 'pad_sequence', 'to_tensor_inputs',
