...
__all__ = ['EPS', 'data_path', 'model_name', 'model_path', 'model_TR_to_VR', 'firstmodel', 'secondmodel', 'codon_usage_ecoli',
           ...
           'generate_sequences_oneTR', 'EvaluateTR_to_prot', 'find_TR']
...
def EvaluateTR_to_prot(TR, NDGR=1000, offset=0):
...
def find_TR(original_seq: str,
    ...
    EvaluateTR_to_prot(record[0]["New_Variant"],NDGR=1000,offset=0)
    return record
