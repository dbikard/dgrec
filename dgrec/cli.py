"""Command-line interface for DGRec built with Click. Provides the `dgrec genotypes` and `dgrec genotypes_paired` commands for processing FASTQ files from the terminal.

Docs: https://dbikard.github.io/dgrec/API/cli.html.md"""
