"""Machine learning models for predicting TR (Template Region) quality. Includes functions to score individual sequences, predict mutagenesis percentages, and optimize TR sequences using beam search. Uses pre-trained scikit-learn classifiers bundled with the package."""
