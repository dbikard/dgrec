...
# %% auto 0
__all__ = ['data_path', 'model_name', 'model_path', 'model_Sp', 'model_name2', 'model_path2', 'model_Avd_Sp', 'model_whole',
           'model_path_whole', 'score', 'score_list', 'DGR_percentage', 'DGR_percentage_list']
...
# %% ../nbs/API/05_predictions.ipynb 12
...
# %% ../nbs/API/05_predictions.ipynb 13
