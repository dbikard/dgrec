"""Functions to go from a fastq file to a list of genotypes"""
...
def get_UMI_genotype(fastq_path: str, #path to the input fastq file
    ...
    """Takes as input a fastq_file of single read amplicon sequencing, and a reference amplicon sequence.
       Returns a dictionary containing as keys UMIs and as values a Counter of all genotype strings read for that UMI.
    """
    align_param={"match":2,
                 "mismatch":-1, 
                 "gap_open":-1, 
...
def genotype_UMI_counter(UMI_gen_dict):
    ...
    returns a list of genotypes sorted by the number of UMIs detected corresponding to each genotype."""
